...
// The Overlap Questions Preview v3.2 — February 15, 2026
// All systematic fixes + structured URL ingestion fields

export default function OverlapQuestionsPreview() {
  const [expandedStep, setExpandedStep] = useState(9);
  ...
  const steps = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          helper: "Not what you wish they'd say — what they actually said. Copy and paste the exact words. Text messages, emails, reviews, voice messages transcribed. The actual language real humans used about you.",
          tier: "must-ask",
          changed: true
        },
        {
        ...
        },
        {
          ...
          helper: "The pitch version. Does it sound different from how you'd tell a stranger? If so, why? Which version is more honest?",
          tier: "must-ask",
          changed: true
        },
        {
      ...
      questions: [
        {
          ...
          helper: "For each one: What was the client's actual problem? What did they try before you? What did you do that was different? What was the measurable result? What did they say afterward? If you have documented case studies, great. If not, just tell the story. Don't be modest.",
          tier: "must-ask",
          changed: true
        },
        {
        ...
        },
        {
          ...
          text: "What specific phrases appear repeatedly when clients describe your work?",
          helper: "There's usually a gap between how you describe your work and how clients describe it. The client version is almost always better for marketing. What words or phrases show up across multiple testimonials, reviews, or feedback? What do they say that you don't say about yourself?",
          tier: "should-ask",
          changed: true
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          helper: "Not what you think makes you special — what have others actually pointed out? 'I've never had someone do X before.' 'Most people don't do Y.' 'I didn't expect Z.' What surprises people about how you work?",
          tier: "must-ask",
          changed: true
        },
        {
    ...
    },
    {
      ...
      subtitle: "Capture what you have and what needs to be built — with URLs for ingestion",
      questions: [
        {
          ...
          helper: "In your head? Scattered across Google Docs? In emails you have to search for? In a CRM? On your website? In notebooks? Be specific about where different types of information live and how hard it is to find when you need it.",
          tier: "should-ask",
          changed: true
        },
        {
        ...
        },
        {
          ...
          helper: "What pushback do they give before deciding to hire you? Price too high? Timeline too long? Don't understand the value? For each objection, what's your response that actually addresses their concern?",
          tier: "should-ask",
          changed: true
        },
        {
          ...
          helper: "Your main website. We'll scrape this to extract your About page, services, testimonials, and any other content that shows who you are and what you do.",
          tier: "must-ask",
          isNew: true,
          note: "URL ingestion"
        },
        {
          ...
          helper: "Your personal LinkedIn profile. We'll extract your headline, about section, experience, and recommendations.",
          tier: "should-ask",
          isNew: true,
          note: "URL ingestion"
        },
        {
          ...
          helper: "If you use Instagram for your business. We'll analyze captions, content themes, and engagement patterns.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
        {
          ...
          helper: "Your business page or professional profile. We'll extract your about section and any public posts.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
        {
          ...
          helper: "If you have video content. We'll analyze video titles, descriptions, and transcripts.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
        {
          ...
          helper: "If you use TikTok for your business. We'll analyze your content themes and captions.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
        {
          ...
          helper: "Your Google Business listing. We'll extract your business description and reviews.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
        {
          id: "doc_reviews_urls",
          text: "List any review sites where you have profiles or listings (Yelp, Google Reviews, industry-specific sites).",
          helper: "One URL per line. We'll extract reviews and ratings to understand how clients describe your work.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
        {
          id: "doc_press_urls",
          text: "List any press coverage, interviews, podcasts, or articles written about you.",
          helper: "One URL per line. We'll extract quotes, descriptions, and how others position your work.",
          tier: "optional",
          isNew: true,
          note: "URL ingestion"
        },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          helper: "Title and author for each. Example: 'The Lean Startup by Eric Ries'. We'll extract frameworks, language patterns, and philosophies you resonate with.",
          tier: "must-ask",
          isNew: true,
        ...
        },
        {
          ...
          text: "List specific podcast episodes you reference or recommend often.",
          helper: "Paste the URL for each episode (Spotify, Apple Podcasts, YouTube, etc.). We'll extract transcripts and analyze what resonates.",
          tier: "should-ask",
          isNew: true,
          note: "Content ingestion"
        },
        {
          ...
          text: "List YouTube videos that influenced your approach to your work.",
          helper: "Paste the URL for each video. We'll extract transcripts and identify frameworks or language you've adopted.",
          tier: "should-ask",
          isNew: true,
          note: "Content ingestion"
        },
        {
          ...
          text: "List blog posts or articles you reference frequently.",
          helper: "Paste URLs. These should be articles that shaped how you think about your industry, process, or philosophy.",
          tier: "should-ask",
          isNew: true,
          note: "Content ingestion"
        },
        {
          ...
          text: "List thought leaders, authors, or creators you follow closely.",
          helper: "Names or social handles. People whose work consistently influences how you think and communicate.",
          tier: "should-ask",
          isNew: true,
          note: "Content ingestion"
        }
  ...
  const newCount = steps.reduce((sum, step) =>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-8 mb-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h1 className="text-4xl font-bold text-slate-900 mb-2">
                The Overlap Questions v3.2
              </h1>
              <p className="text-lg text-slate-600">
                Systematic polish + structured URL ingestion for ScrapSync
              </p>
            </div>
          ...
          <div className="flex items-center gap-6 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-700">{changedCount - newCount} polished</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-blue-500"></div>
              <span className="text-slate-700">{newCount} new (15 for ingestion)</span>
            </div>
          </div>
        </div>
                              ...
                              <div className="flex items-start justify-between gap-4 mb-3">
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                                    ...
                                    {q.note && (
                                      <span className="text-xs font-medium px-2 py-1 rounded bg-purple-100 text-purple-700 border border-purple-200">
                                        {q.note}
                                      </span>
                                    )}
                                  </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-slate-800 to-slate-900 text-white rounded-xl p-8 shadow-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold mb-1">v3.2</div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-700">
            <div className="text-sm text-slate-300">
              <strong>New:</strong> 15 URL ingestion fields for ScrapSync pipeline<br/>
              <strong>Structure:</strong> Digital presence (10) + Media influences (5)
            </div>
          </div>
        </div>
      </div>
