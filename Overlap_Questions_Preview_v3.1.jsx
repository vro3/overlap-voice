...
// The Overlap Questions Preview v3.1 — February 15, 2026
// All systematic fixes applied from review feedback
  ...
  const steps = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          tier: "should-ask",
          isNew: true,
          note: "Moved from Meta Questions"
        }
      ]
    },
    {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-8 mb-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h1 className="text-4xl font-bold text-slate-900 mb-2">
                The Overlap Questions v3.1
              </h1>
              <p className="text-lg text-slate-600">
                All review feedback systematically applied
              </p>
            </div>
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-700">{newCount} new</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-slate-800 to-slate-900 text-white rounded-xl p-8 shadow-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold mb-1">v3.1</div>
